    ...
    if (!data.noData) {
      return Container(
        child: Stack(
          children: <Widget>[
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0, left: 24.0,top: 25.0,right: 24.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text('Free Courses',style: kCourseTagStyle,),
                  Text('${data.searchedData['free'].length} free course(s)', style: kCourseCountTextStyle),
                ],
              ),
            ),
            ListView.builder(
      ...
      return Center(
        ...
        width: 200,
              ...
              Text('No Courses Found.',style: kErrorTextStyle.copyWith(fontSize: 16.0),),

              Text('Check your internet connection\n or search a relevant course.',style: kErrorTextStyle,)
            ],
          ));
    }
  }
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text('Hold On..',style: kErrorTextStyle,)
                    ],
                  ),
                ),
              ),
